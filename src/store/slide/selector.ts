...
// export const getPresentationName = (state: RootState) => state.pres?.presentation.name
...
export const getPresentationTheme = (state: RootState) => state.pres.presentationTheme
